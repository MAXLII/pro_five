...
#
# Generated by Vivado on Sat Dec 17 12:57:52 +0800 2022
# SW Build 3526262 on Mon Apr 18 15:48:16 MDT 2022
#
# Tool Version Limit: 2022.04 
#
# usage: ram_4kx8.sh [-help]
# usage: ram_4kx8.sh [-lib_map_path]
# usage: ram_4kx8.sh [-noclean_files]
# usage: ram_4kx8.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "ram_4kx8.sh - Script generated by export_simulation (Vivado v2022.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L blk_mem_gen_v8_4_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram_4kx8 xil_defaultlib.ram_4kx8 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ram_4kx8 -key {Behavioral:sim_1:Functional:ram_4kx8} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./ram_4kx8.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ram_4kx8.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./ram_4kx8.sh -help\" for more information)\n"
    exit 1
  fi
