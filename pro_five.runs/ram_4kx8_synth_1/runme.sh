...
HD_PWD='D:/OneDrive/LWX/Project/MCS51/vivado/pro_five/pro_five.runs/ram_4kx8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_4kx8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_4kx8.tcl
