...
HD_PWD='D:/OneDrive/LWX/Project/MCS51/vivado/pro_five/pro_five.runs/rom_16kx8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_16kx8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_16kx8.tcl
